...
if ENDING == "er":
    ...
    FUTURE_STEM = CONDITIONAL_STEM = STEM + "er"
...
if ENDING == "ir":
    ...
    FUTURE_STEM = CONDITIONAL_STEM = STEM + "ir"
    passe_simple_endings = ["is", "is", "it", "îmes", "îtes", "irent"]
    past_participle_ending = "i"
    match TARGET:
        case "avoir":
            FUTURE_STEM = CONDITIONAL_STEM = f"{RED}aur{RESET}"
...
if ENDING == "re":
    ...
    FUTURE_STEM = CONDITIONAL_STEM = STEM + "r"
    passe_simple_endings = ["is", "is", "it", "îmes", "îtes", "irent"]
    match TARGET:
        case "boire":
        ...
        case "être":
            ...
            FUTURE_STEM = CONDITIONAL_STEM = f"{RED}serr{RESET}"
        case "frire":
...
if TARGET[-5:] == "faire":
    ...
    FUTURE_STEM = CONDITIONAL_STEM = TARGET[:-4] + f"{RED}er{RESET}"
...
future = [f"{FUTURE_STEM}{j}" for j in future_endings]
conditional = [f"{CONDITIONAL_STEM}{j}" for j in conditional_endings]
